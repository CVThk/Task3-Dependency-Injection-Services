    ...
    public class Execute
    {
        public void runMain()
        {
            try
            {
                ...
                IStudentService studentService = new StudentService(new Database());
                List<Student> dssv = studentService.All;

                ISubjectService subjectService = new SubjectService(new Database());
                List<Subject> dsmh = subjectService.All;

                ITranscriptService transcriptService = new TranscriptService(new Database());
